...
# and background mortality of below-dam spawners.

# The relevant sections in the paper are:
# - Methods: 2.3.3
# - Results: 3.2
# - Figures: Figures 5 b) & S1.7
...
source('HunderTroutIPM_IPM_Building_mO2Scenarios.R')
...
## ORIGINAL
IPM1.orig <- build.IPM(t=test.year, sex=1, orig=1, m0, Mu.mj, Mu.mdam, Mu.mOs, beta2.mj, beta2.mdam, beta2.mOs, dPenalty.0=1, dPenalty.j=1, l.limit=Lx, u.limit=Ux, mH.factor=1, mO2.factor=1)$IPM

IPM2.orig <- build.IPM(t=test.year, sex=1, orig=1, m0, Mu.mj, Mu.mdam, Mu.mOs, beta2.mj, beta2.mdam, beta2.mOs, dPenalty.0=1.5, dPenalty.j=1, l.limit=Lx, u.limit=Ux, mH.factor=1, mO2.factor=1)$IPM

IPM3.orig <- build.IPM(t=test.year, sex=1, orig=1, m0, Mu.mj, Mu.mdam, Mu.mOs, beta2.mj, beta2.mdam, beta2.mOs, dPenalty.0=2, dPenalty.j=1, l.limit=Lx, u.limit=Ux, mH.factor=1, mO2.factor=1)$IPM
...
pop.analysis <- function(t, sex, orig, m0, Mu.mj, Mu.mdam, Mu.mOs, beta2.mj, beta2.mdam, beta2.mOs, dPenalty.0, dPenalty.j, l.limit, u.limit, mH.factor, mO2.factor){

	# Build IPM
	IPM <- build.IPM(t, sex, orig, m0, Mu.mj, Mu.mdam, Mu.mOs, beta2.mj, beta2.mdam, beta2.mOs, dPenalty.0, dPenalty.j, l.limit, u.limit, mH.factor, mO2.factor)$IPM
	...
	# Collate results
	results <- data.frame(mH.factor = mH.factor, mO2.factor = mO2.factor, lambda = lambda)
...
test1.X <- do.call("rbind", sapply(1:nrow(pert.params), FUN = function(z) pop.analysis(test.year, 1, 1, m0, Mu.mj, Mu.mdam, Mu.mOs, beta2.mj, beta2.mdam, beta2.mOs, dPenalty.0=1, dPenalty.j=1, l.limit=Lx, u.limit=Ux, mH.factor=pert.params[z,1], mO2.factor=pert.params[z,2]), simplify = FALSE))

res1.mat <- matrix(test1.X$lambda, nrow = length(mH.fac), ncol = length(mO.fac), dimnames = list(mH.fac, mO.fac))

test2.X <- do.call("rbind", sapply(1:nrow(pert.params), FUN = function(z) pop.analysis(test.year, 1, 1, m0, Mu.mj, Mu.mdam, Mu.mOs, beta2.mj, beta2.mdam, beta2.mOs, dPenalty.0=1.5, dPenalty.j=1, l.limit=Lx, u.limit=Ux, mH.factor=pert.params[z,1], mO2.factor=pert.params[z,2]), simplify = FALSE))

res2.mat <- matrix(test2.X$lambda, nrow = length(mH.fac), ncol = length(mO.fac), dimnames = list(mH.fac, mO.fac))

test3.X <- do.call("rbind", sapply(1:nrow(pert.params), FUN = function(z) pop.analysis(test.year, 1, 1, m0, Mu.mj, Mu.mdam, Mu.mOs, beta2.mj, beta2.mdam, beta2.mOs, dPenalty.0=2, dPenalty.j=1, l.limit=Lx, u.limit=Ux, mH.factor=pert.params[z,1], mO2.factor=pert.params[z,2]), simplify = FALSE))
...
title (ylab = 'Decrease in below-dam mortality (spawners)', line=3.8, cex.lab=1.3)
...
axis(1, at = mH.fac[prop.ind], labels = perc.dec, cex.axis = 1.2)
axis(2, at = mO.fac[prop.ind], labels = perc.dec, las = 1, cex.axis = 1.2)
contour(res2.mat, add = TRUE, levels = c(0.8, 0.9, 1.0, 1.1), col = 'white', labcex = 1, method = 'edge', lty = c(2,2,1,2), crt = 90, drawlabels = F)
